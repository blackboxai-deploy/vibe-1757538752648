...
export default function AnniversaryCelebration() {
  ...
  useEffect(() => {
    const targetDate = new Date('2024-11-18T00:00:00').getTime()
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            November 18, 2024 - Celebrating one incredible year of love, growth, and beautiful memories together.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="relative">
            <img
              src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/be77e8c2-68c3-4976-b178-90e67e2f1ba6.png"
              alt="Kevin and Jaymee anniversary celebration with romantic dinner, candles, and elegant setting"
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white text-center">
              <h3 className="text-3xl md:text-4xl font-bold mb-2">November 18, 2024</h3>
