        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="relative">
            <div className="bg-gradient-to-r from-pink-100 to-rose-100 rounded-3xl p-8 shadow-lg">
              <img 
                src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/48e780fe-ecc0-440b-adbb-341db99795e9.png" 
                alt="Kevin and Jaymee celebrating their beautiful love story together - romantic couple photo"
